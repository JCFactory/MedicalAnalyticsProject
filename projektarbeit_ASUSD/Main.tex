...
As described in \ref{lessons_learned}, the problem of the unsupervised clustering algorithm and the genome-sepcific data came up. As a counterproposal for future analysis, a supervised technique like K-Means-Clustering could be used. 
